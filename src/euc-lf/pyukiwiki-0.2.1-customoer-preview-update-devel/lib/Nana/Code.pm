...
sub conv {
	...
	&init;
	if($::lang eq "ja") {
		$$contentref=~s/\xef\xbd\x9e/\xe3\x80\x9c/g;# ¡Á # comment
		if($Code::Method eq "Jcode") {
			&Jcode::convert($contentref, $kanjicode, $icode);
		}
		$$contentref=~s/\xe3\x80\x9c/\xef\xbd\x9e/g;# ¡Á # comment
	}
	return $$contentref;
}
...
L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/lib/Nana/Code.pm?view=log>

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/lib/Nana/Code.pm?view=log>
