...
L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/lib/stdin.inc.pl?view=log>

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/lib/stdin.inc.pl?view=log>
