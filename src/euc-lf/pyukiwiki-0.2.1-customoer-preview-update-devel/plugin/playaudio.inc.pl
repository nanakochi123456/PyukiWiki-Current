...
L<http://pyukiwiki.info/PyukiWiki/Plugin/Nanami/playaudio/>
...
L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel-UTF8/plugin/playaudio.inc.pl?view=log>
