...
L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/lib/ignoreoldbrowser.inc.pl?view=log>

L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/lib/ignoreoldbrowser.inc.pl?view=log>
