...
L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/plugin/metarobots.inc.pl?view=log>

L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/plugin/metarobots.inc.pl?view=log>
