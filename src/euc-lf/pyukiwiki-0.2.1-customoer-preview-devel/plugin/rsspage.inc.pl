...
L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/plugin/rsspage.inc.pl?view=log>

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/plugin/rsspage.inc.pl?view=log>
