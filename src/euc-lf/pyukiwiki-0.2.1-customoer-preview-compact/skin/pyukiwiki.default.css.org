...
a:hover {
	color:#215dc6;				/* #215dc6; */
	background-color:#ccddee;	/* #ccddee;	*/
...
h3 {
	font-family:verdana, arial, helvetica, Sans-Serif;
	border-bottom:  3px solid #ddeeff;	/* #DDEEFF; */
	border-top:     1px solid #ddeeff;	/* #DDEEFF; */
	border-left:   10px solid #ddeeff;	/* #DDEEFF; */
	border-right:   5px solid #ddeeff;	/* #DDEEFF; */
	color:inherit;
	background-color:#ffffff;	/* #ffffff */
	padding:.3em;
	margin:0px 0px .5em 0px;
...
h4 {
	font-family:verdana, arial, helvetica, Sans-Serif;
	border-left:18px solid #ddeeff;	/* #ddeeff; */
	color:inherit;
	background-color:#ffffff;		/* #ffffff; */
	padding:.3em;
	margin:0px 0px .5em 0px;
...
pre {
	border-top:#ddddee 1px solid;		/* #ddddee */
	border-bottom:#888899 1px solid;	/* #888899 */
	border-left:#ddddee 1px solid;		/* #ddddee */
	border-right:#888899 1px solid;		/* #888899 */
	padding:.5em;
	margin-left:1em;
	margin-right:2em;
/*	white-space:pre;*/
...
tfoot td.style_td {
	color:inherit;
	background-color:#d0d8e0;		/* #d0d8e0; */
	/* force br ? */
}
thead th.style_th,
tfoot th.style_th {
	color:inherit;
	background-color:#e0e8f0;		/* #e0e8f0; */
	/* force br ? */
}
.style_table {
	padding:0px;
...
.noexists {
	color:inherit;
	background-color:#fffacc;	/* #fffacc; */
}
