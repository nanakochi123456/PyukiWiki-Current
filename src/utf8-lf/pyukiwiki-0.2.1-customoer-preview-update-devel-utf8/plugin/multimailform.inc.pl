...
L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/plugin/multimailform.inc.pl?view=log>

L<http://osdn.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/plugin/multimailform.inc.pl?view=log>
