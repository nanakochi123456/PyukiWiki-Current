...
#		added Gaisbot/3.0 (<robot05 (at) gais (dot) cs (dot) ccu (dot) edu (dot) tw>; )
#		dded geniebot (<wgao (at) genieknows (dot) com>)
...
#		added OutfoxBot/0.3 (For internet experiments; <outfox (dot) agent (at) gmail (dot) com>)
#		added RufusBot Rufus Web Miner http://64.124.122.252.webaroo.com/feedback.html
#		added Seekbot (http://www.seekbot.net/bot.html)
#		added Yahoo-MMCrawler/3.x (<mms-mmcrawler-support (at) yahoo-inc (dot) com>)
...
#		added link for ZyBorg/1.0 (<wn-14 (dot) zyborg (at) looksmart (dot) net>; http://www.WISEnutbot.com.  Moved location to above wisenut to avoid classification as wisenut
# 2005-12-15
...
#		added lmspider (<lmspider (at) scansoft (dot) com>) http://www.nuance.com/
...
#		added virus_detector <virus_harvester (at) securecomputing (dot) com>
#		added Wavefire http://www.wavefire.com; <info (at) wavefire (dot) com>
#		added WebFilter Robot
# 2006-01-24
#		added Shim-Crawler http://www.logos.ic.i.u-tokyo.ac.jp/crawler/; <crawl (at) logos (dot) ic (dot) i (dot) u-tokyo (dot) ac (dot) jp>
...
#		added IlTrovatore-Setaccio	http://www.iltrovatore.it/aiuto/motore_di_ricerca.html	<bot (at) iltrovatore (dot) it>
#		added InsurancoBot	http://www.fastspywareremoval.com/
#		added InternetArchive	http://lucene.apache.org/nutch/bot.html 	<nutch-agent (at) lucene (dot) apache (dot) org>
#		added KazoomBot	http://www.kazoom.ca/bot.html	<kazoombot (at) kazoom (dot) ca>
#		added Kurzor	http://www.easymail.hu/	<cursor (at) easymail (dot) hu>
#		added NutchCVS	http://lucene.apache.org/nutch/bot.html	<nutch-agent (at) lucene (dot) apache (dot) org>
#		added NutchOSU-VLIB	http://lucene.apache.org/nutch/bot.html	<nutch-agent (at) lucene (dot) apache (dot) org>
...
#		added SynooBot	http://www.synoo.de/bot.html	<webmaster (at) synoo (dot) com>
...
#		added FAST Enterprise Crawler * <crawleradmin (dot) t-info (at) telekom (dot) de> http://www.telekom.de/
#		added FAST Enterprise Crawler http://www.fast.no/
#		added FAST Enterprise Crawler * T-Info_BI_cluster <crawleradmin (dot) t-info (at) telekom (dot) de> http://www.telekom.de/
...
#		added versus crawler from <eda (dot) baykan (at) epfl (dot) ch> http://www.epfl.ch/Eindex.html
