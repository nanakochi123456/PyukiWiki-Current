...
L<http://pyukiwiki.info/PyukiWiki/Dev/Specification/wiki_link.cgi/>

=item PyukiWiki CVS

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/lib/wiki_link.cgi?view=log>

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/lib/wiki_link.cgi?view=log>

L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel/lib/wiki_link.cgi?view=log>

L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel-UTF8/lib/wiki_link.cgi?view=log>
...
sub _make_link {
	...
	my $follow;
	my $followtag=$::followtag_pub;

	if($chunk=~/$::isurl/) {
		$followtag=qq( rel="nofollow");
	} else {
		$followtag=qq( rel="follow");
	}
