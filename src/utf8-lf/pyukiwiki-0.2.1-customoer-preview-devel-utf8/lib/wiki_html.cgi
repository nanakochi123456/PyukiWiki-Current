...
L<http://pyukiwiki.info/PyukiWiki/Dev/Specification/wiki_html.cgi/>

=item PyukiWiki CVS

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel/lib/wiki_html.cgi?view=log>

L<http://sfjp.jp/cvs/view/pyukiwiki/PyukiWiki-Devel-UTF8/lib/wiki_html.cgi?view=log>

L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel/lib/wiki_html.cgi?view=log>

L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel-UTF8/lib/wiki_html.cgi?view=log>
...
sub _highlight {
	...
	if($::highlight_exec eq 0 && $::pushedpage eq '') {
		...
		my $cwd=&highlight($wd, $wd);	# 検索ワードを再帰
