...
L<http://pyukiwiki.info/PyukiWiki/Plugin/Admin/listfrozen/>
...
L<http://cvs.pyukiwiki.info/cgi-bin/cvsweb.cgi/PyukiWiki-Devel-UTF8/plugin/listfrozen.inc.pl?view=log>
